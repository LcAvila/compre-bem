...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="produto-img/Foto principal.jpg" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="produto-img/carrossel2.jpg" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="produto-img/carrossel3.jpg" class="d-block w-100"
					alt="...">
			</div>
		</div>
	...
	<div class="container_main">
		...
		<div class="card" style="width: 18rem;">
			<img src="produto-img/Card 1 calça.webp" class="card-img-top" alt="...">
			<div class="card-body">
			...
			<div class="card" style="width: 18rem;">
				<img src="produto-img/card2.webp" class="card-img-top" alt="..."
					id="card-2">
				<div class="card-body">
					<h5 class="card-title"></h5>
					<div class="card-text">
						<p>Vestido midi com alça em material sintético com fenda preto
						</p>
					</div>
					<h6>R$ 180,00</h6>
					<a href="#" class="btn btn-primary">Comprar</a>
			...
			<div class="card" style="width: 18rem;">
				<div class="img-card">
					<img src="produto-img/card 4.webp" class="card-img-top" alt="..."
						id="card-4">
				</div>
	...
	<div class="conteiner">
		<div class="desenvolvido-por">Desenvolvido por RioTech &copy;
			2023</div>
	</div>
